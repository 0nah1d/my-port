...
const TitleScroll = () => {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            if (!titleScroll) return

            const text1 =
                titleScroll.querySelector<HTMLDivElement>('.firstTitle')
            const text2 =
                titleScroll.querySelector<HTMLDivElement>('.secondTitle')
            const icons = titleScroll.querySelectorAll<
                SVGElement | HTMLElement
            >('.titleIcon')

            if (!text1 || !text2) return

            gsap.set(text1, { xPercent })
            gsap.set(text2, { xPercent })
